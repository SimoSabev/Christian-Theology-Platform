...
export const timelineEvents = [
  ...
  { year: 350, title: 'Desert Fathers Movement — Anthony, Pachomius, and the contemplative tradition', category: 'figure', era: 'Nicene', relatedWayHref: '/way/pray/silent-prayer' },
  ...
  { year: 1209, title: 'Francis of Assisi founds the Franciscans', category: 'figure', era: 'Medieval', relatedWayHref: '/way/love/saints' },
  { year: 1265, title: 'Aquinas begins Summa Theologiae', category: 'document', era: 'Medieval' },
  { year: 1341, title: 'Palamite Councils — Gregory Palamas & Hesychasm affirmed', category: 'council', era: 'Medieval', relatedWayHref: '/way/pray/jesus-prayer' },
